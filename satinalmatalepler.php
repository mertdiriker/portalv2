...
<button class="btn btn-primary" name="submit">Reddet</button>
    ...
    <td><?php echo $cikti["satinalma_Siparistarih"];?></td>
		<?php if($_SESSION['yetki']=='onay' || $_SESSION['id']=='15'){ ?>
  ...
  <form action="excelexport.php">
		<button class="btn btn-primary" name="submit">Excel e Cikar</button>
		</form>
