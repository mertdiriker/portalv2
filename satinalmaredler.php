...
$stmt = $con->prepare('SELECT * FROM satinalma');
...
<div class="content" style="width:1500px;">
  ...
  <th>Siparis Tarih|</th>
    ...
    <?php while ($cikti = $sonuc->fetch_array())
					{ if($cikti['satinalma_Durum']=='Red' && $cikti["satinalma_Silindi"]==FALSE) {?>
    <tr>
    ...
    <td><?php echo $cikti["satinalma_Talepbirim"]?></td>
		...
		<td style="background:#6459f7;"><?php echo $cikti["satinalma_Durum"];?><?php 
if($_SESSION['yetki']=='teklif' && $cikti["satinalma_Durum"]=='Siparis verilmesi bekleniyor'){ ?>
<a href="satinalmasiparis.php?id=<?php echo $cikti["satinalma_ID"];?>">&emsp;&emsp;<label style="color:orange;">Sipariş verildi<label>
<?php } ?>
			<?php } ?> 


	<td><a href="satinalmaduzenlered.php?id=<?php echo $cikti["satinalma_ID"];?>">Duzenle</a></td>
  ...
  <td><a href="satinalmapdfdisplay.php?id=<?php echo $cikti["satinalma_ID"];?>">PDF'i Gör</a></td>
    <td><?php echo $cikti["satinalma_Talepci"];?></td>
