...
<html lang="en">
  ...
  <body>
    <h1 class="text-center">Reçete</h1>    
 ...
 $stmt->close();
    ...
    {if ($cikti["Urunrecete_Silindi"]==FALSE){?>
            ...
            <td>
                <form action="silrecete.php?id=<?php echo $cikti["Urunrecete_Urun2ID"];?>&id2=<?php echo $cikti["Urunrecete_UrunID"];?>&kod=<?php echo $urunkod;?>" method="post">
                <button class="btn btn-primary" name="submit">Çıkar</button></form>
