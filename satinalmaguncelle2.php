...
?>
    ...
    <?php while ($cikti = $sonuc->fetch_array())
					{if ($cikti["Tedarikci_Silindi"]==FALSE){?>
    <tr><td><?php echo $cikti["Tedarikci_ID"];?></td>
    <td><?php echo $cikti["Tedarikci_Ad"];?></td>
  
   
    
    <td><a href="edittedarikci.php?id=<?php echo $cikti["Tedarikci_ID"];?>">Düzenle</td>
