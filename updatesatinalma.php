...
$stmt = $con->prepare('UPDATE satinalma SET satinalma_Teklif1firma = ?,satinalma_Teklif2firma = ?,satinalma_Teklif3firma = ?,satinalma_Teklif1fiyat = ?,satinalma_Teklif2fiyat = ?,satinalma_Teklif3fiyat = ?,satinalma_Durum = ?,satinalma_Teklif1fiyattur = ?,satinalma_Teklif2fiyattur = ?,satinalma_Teklif3fiyattur = ?,satinalma_TeklifAciklama1 = ?,satinalma_TeklifAciklama2 = ?,satinalma_TeklifAciklama3 = ? WHERE satinalma_ID=?');

$stmt->bind_param('ssssssssssssss',$firma1,$firma2,$firma3,$fiyat1,$fiyat2,$fiyat3,$durum,$fiyat1tur,$fiyat2tur,$fiyat3tur,$aciklama1,$aciklama2,$aciklama3,$talepid);	
$stmt->execute();
